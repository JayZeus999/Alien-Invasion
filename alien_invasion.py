...
class AlienInvasion:
    ...
    def _create_constellation(self):
        """Create a constellation of aliens."""
        # Create a star and keep adding stars until there's no room left.
        # Spacing between stars is one star width.
        star = Star(self)
        star_width, star_height = star.rect.size

        current_x, current_y = star_width, star_height
        random_number = randint(-10, 10)
        while current_y < (self.settings.screen_height - random_number):
            while current_x < (self.settings.screen_width - random_number):
